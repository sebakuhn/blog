...
// Rendered in array order: linkedin, bluesky, github, mastodon. The entries
// below them stay unconfigured in site.config.ts and are filtered out, so their
// position does not matter. Keep in sync with components/Footer.tsx.
const socialLinks: SocialLink[] = [
  ...
  config.mastodon && {
    name: 'mastodon',
    // mastodon is decentralized, so the instance is part of the configured URL —
    // don't rebuild the href from a handle the way the other entries do
